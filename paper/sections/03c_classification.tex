...
We used the support vector machine implementation LIBSVM\footnote{\url{http://www.csie.ntu.edu.tw/~cjlin/libsvm/}}, as described by Fan et al.~\cite{fan2005working}. The default configuration of type C-SVC and a radial basis function kernel returned satisfactory results.
% TODO: We only adapted the cost $c=1000$, which ...
