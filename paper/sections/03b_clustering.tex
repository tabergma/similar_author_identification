...
We use a k-means algorithm for the initial clustering of our documents because TODO??.
...
We implemented three cluster labelling methods to try and add meaningful labels to the clusters we determined in the previous step.
These methods use the clusters' feature vectors to discern their interesting and meaningful properties.
