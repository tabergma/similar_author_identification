...
public class Config {
    ...
    public final static String EVALUATION_FEATURE_RECALL_FILE = RESULT_PATH + "evaluation_features_recall";
    public final static String EVALUATION_FEATURE_CLUSTER_FILE = RESULT_PATH + "evaluation_features_cluster";
